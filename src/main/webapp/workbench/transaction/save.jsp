	...
	<script>
		...
		/*
			...
			关于阶段和可能性
				...
				如果同时满足以上两条结论，那么我们将这样的数据保存到数据库中就没有意义了
		...
		$(function () {
			...
			//为阶段下拉框，绑定下拉框选中下拉框事件，根据选中的阶段填写可能性
			$("#create-stage").change(function () {
				...
				/*
					...
					因为今天的stage是一个可变的数据
					如果是这样的key，那么我们不能以json.key的形式来取值
					我们要使用的取值方式为
					json[key]
	...
	<form action="workbench/transaction/save.do" id="tranForm" method="post" class="form-horizontal" role="form" style="position: relative; top: -30px;">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				...
				<input type="hidden" name="activityId" value="4b9a7266b48d4a82adf47c87899a62d8"/>
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control" id="create-contactsName" value="太君000">
				<input type="hidden" name="contactsId" value="f3106baa5f86427fa9c724b5da89c7d7"/>
			</div>
		</div>
