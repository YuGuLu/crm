<%@ page import="com.yu.crm.settings.domain.DicValue" %>
<%@ page import="java.util.List" %>
<%@ page import="java.util.Map" %>
<%@ page import="java.util.Set" %>
<%@ page import="com.yu.crm.workbench.domain.Tran" %>
...
;
			...
			success : function (data) {
                ...
                */
				if(data.success){
					...
					//改变阶段成功，需要在详细信息页上局部刷新：阶段、可能性、修改时间、修改人
	...
	function changeIcon(stage,index1) {
		...
		//如果当前阶段的可能性为0 前七个一定是黑圈，后两个一个是黑叉，一个是红叉
		...
		//如果当前阶段的可能性不为0，前几个可能是绿圈，绿色标记，黑圈，后两个一定是黑叉
		}else{
...
<body>
	...
	<div style="position: relative; left: 40px; top: -50px;">
		...
		<%
			...
			//如果当前阶段的可能性不为0，前七个有可能是绿圈，黑拳，绿色标记，后两个一定是黑叉
			}else{
