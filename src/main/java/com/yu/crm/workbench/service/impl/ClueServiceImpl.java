...
import com.yu.crm.workbench.dao.*;
...
public class ClueServiceImpl implements ClueService {
    ...
    public boolean convert(String clueId, Tran t, String createBy) {
        ...
        //（2）通过线索对象提取客户信息，当客户不存在时，新建客户（根据公司的名称精确匹配，判断客户是否存在）
        ...
        //-------------------------------------------------------------------------------------------------------
        //经过第二步处理后，客户的信息我们已经拥有了，将来在处理其他表的时候，如果要用到客户的id，直接使用cus.getId()
        //-------------------------------------------------------------------------------------------------------
        ...
        //-------------------------------------------------------------------------------------------------------
        //经过第三步处理后，联系人的信息我们已经拥有了，将来在处理其他表的时候，如果要用到联系人的id，直接使用con.getId()
        //-------------------------------------------------------------------------------------------------------

        //(4)将线索的备注转换到客户的备注以及联系人的备注
        //查询出与该线索关联的备注信息列表
        ...
        //查询出与该条线索关联的市场活动，查询出与市场活动的关联关系列表
