package com.yu.crm.workbench.service.impl;

import com.yu.crm.utils.DateTimeUtil;
import com.yu.crm.utils.SqlSessionUtil;
import com.yu.crm.utils.UUIDUtil;
import com.yu.crm.workbench.dao.CustomerDao;
import com.yu.crm.workbench.dao.TranDao;
import com.yu.crm.workbench.dao.TranHistoryDao;
import com.yu.crm.workbench.domain.Customer;
import com.yu.crm.workbench.domain.Tran;
import com.yu.crm.workbench.domain.TranHistory;
import com.yu.crm.workbench.service.TranService;
...
public class TranServiceImpl implements TranService {
    ...
    public boolean save(Tran t, String customerName) {
        ...
        //通过以上对于客户的处理，不论是查询出来已有的客户，还是以前没有新增的客户，总之客户已经有了，客户的id就有了
        //将客户的id封装到t对象中
